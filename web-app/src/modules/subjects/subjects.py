...
from ...repositories.abstracts.AbcSubjectRepository import AbcSubjectRepository
from ...repositories.SubjectRepository import SubjectRepository

from ...services.abstracts.AbcSubjectService import AbcSubjectService
from ...services.SubjectService import SubjectService


__subjectrepository: AbcSubjectRepository = SubjectRepository()
...
def overview():
    ...
    if not all_subjects:
        all_subjects = cache_manager.set_by_key(
            ...
            __subjectrepository.get_all_ordered_by_name(),
            cache_manager._ONEDAY
        )

    return render_template(
        'overview.jinja2',
        subjects=__subjectservice.subjectlist_to_subjectoverviewviewmodellist_mapping(all_subjects)
    )
